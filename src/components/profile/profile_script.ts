...
export default class Profile extends Vue {
  basicProfiles: basicProfilesType[] = [
    ...
    },
    {
      tag: "紹介文",
      text:
        "京都のIT企業でIoT.kyotoVIS(https://vis2.iot.kyoto)というIoT向けアプリケーションを開発しています。また、IoTデバイスからデータを取得して蓄積して可視化するまでの開発を経験しました。AWSにどっぷりな(フロントサイド)エンジニア。最近はVueに魅了され、ほぼ独断で自社アプリを書き換えてしまいました。Serverlessなアーキテクチャが好物。"
    },
    {
      tag: "Language",
      text:
